                ...
                <div class="collapse navbar-collapse navbar-ex1-collapse">
                    ...
                    <div id="page-wrapper">
                        <div class="container-fluid">
                            ...
                            <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Edit Data Poli</h1>
                    </div>
                    <div class="container mt-5">
                        <!-- Form to edit obat data -->
                        <form method="post" action="edit_poli.php">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="nama" name="nama" value="<?php echo $nama_poli ?>" required>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <a href="data_poli.php" class="btn btn-primary">Kembali</a>
                        </form>
                    </div>
                </div>
