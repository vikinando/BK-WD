        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                    ...
                    <div>
                        <!-- Tombol tambah data -->
                        <a href="mengelola_dr.php" class="btn btn-success mb-3">Tambah Data</a>
                        ...
                        <table class="table">
                            ...
                            <?php
                                ...
                                if (isset($_GET['id'])) {
                                    ...
                                    $delete_query = "DELETE FROM dokter WHERE id = $id_to_delete";
                                    
                                    if (mysqli_query($conn, $delete_query)) {
                                        echo '<a href="data_dokter.php" class="btn btn-primary">Kembali ke Data dokter</a>';
                                ...
                                if ($result) {
                                    while ($row = mysqli_fetch_assoc($result)) {
                                        ...
                                        echo "<td>";
                                        echo "<a href='edit_dr.php?id={$row['id']}' class='btn btn-primary btn-sm'>Edit</a>";
                                        echo "&nbsp;";
                                        echo "<a href='data_dr.php?id={$row['id']}' class='btn btn-danger btn-sm' onclick=\"return confirm('Apakah Anda yakin ingin menghapus data ini?')\">Hapus</a>";
                                        echo "</tr>";
